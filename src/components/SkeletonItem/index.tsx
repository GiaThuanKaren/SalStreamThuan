function Skeleton() {
  return (
    <>
      <div className="animate-pulse  basis-1/2 lg:basis-1/3 xl:basis-1/4 2xl:basis-1/5 min-h-[250px]  px-5 py-1 my-3">
        {/*  contend Movie */}
        <div className="h-full  w-full">
          <div className="relative">
            ...
            <div className="px-2 py-1 h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[480px] mb-2.5"></div>
